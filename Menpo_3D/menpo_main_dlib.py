...
from menpo_dataloader_dlib import Menpo
...
train_data = Menpo(root_path='/home/kak/Documents/DFKI/MenpoTracking/Menpo_Challenge/Train_data/')

val_data = Menpo(root_path ='/home/kak/Documents/DFKI/MenpoTracking/Menpo_Challenge/Val_data/')
...
# for params in network_FAN.parameters():
...
optimizer = optim.Adam(network_FAN.parameters(), lr=0.0001)
...
trainer = Trainer(cuda, network_FAN, network_depth, optimizer, criterion, train_loader, val_loader, out)
trainer.train()
#---------------------------------------------------------------------------------------------
