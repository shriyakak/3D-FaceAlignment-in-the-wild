...
- Menpo Dataset
Note: For Menpo dataset access you need to drop an email to contact mentioned at this site (https://ibug.doc.ic.ac.uk/resources/1st-3d-face-tracking-wild-competition/) 
- PyTorch
- OpenCV 
- Dlib Face detector
