...
class Menpo(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(len(model_space_landmarks_3d)):
            if(i<=32):
                if(i%2 == 0):
                    landmarks_3D.append(model_space_landmarks_3d[i])
            else:
                landmarks_3D.append(model_space_landmarks_3d[i])
        ...
        #--------------------Bounding box-------------------------------#
        # bb = create_bounding_box(landmarks_68)
        # center2, scale2 = get_center_scale(bb)
        #--------------------------------------------------------------------
        ...
        z_coordinate_68 = landmarks_3D[:,2]
